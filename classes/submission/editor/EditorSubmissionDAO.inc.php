...
class EditorSubmissionDAO extends DAO {
    ...
    public $articleFileDao = null; // Added implicit property
     ...
     */
    public function EditorSubmissionDAO() {
     ...
     * @param int $articleId
     * @return EditorSubmission|null
     */
    public function getEditorSubmission($articleId) {
        ...
        if ($result->RecordCount() != 0) {
            ...
            $returner = $this->_returnEditorSubmissionFromRow($row);
        }
     ...
     */
    public function _returnEditorSubmissionFromRow($row) {
        ...
        HookRegistry::dispatch('EditorSubmissionDAO::_returnEditorSubmissionFromRow', [&$editorSubmission, &$row]);
     ...
     * @return int
     */
    public function insertEditorSubmission($editorSubmission) {
        // [WIZDAM] Type Guard
        if (!($editorSubmission instanceof EditorSubmission)) return 0;
        ...
        $this->update(
            ...
            [
                (int) $editorSubmission->getId(),
                (int) $editorSubmission->getEditorId()
            ]
        );
     ...
     * @param EditorSubmission $editorSubmission
     */
    public function updateEditorSubmission($editorSubmission) {
        // [WIZDAM] Type Guard
        if (!($editorSubmission instanceof EditorSubmission)) return;
     ...
     * @param int $sectionId
     * @param int $editorId
     * @param int|null $searchField SUBMISSION_FIELD_... identifier
     * @param string|null $searchMatch "is" or "contains" or "startsWith"
     * @param string|null $search
     * @param int|null $dateField SUBMISSION_FIELD_DATE_... identifier
     * @param string|null $dateFrom
     * @param string|null $dateTo
     * @param string|null $additionalWhereSql
     * @param object|null $rangeInfo
     * @param string|null $sortBy
     * @param int $sortDirection
     * @return object DAOResultFactory
     */
    public function getUnfilteredEditorSubmissions($journalId, $sectionId = 0, $editorId = 0, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $additionalWhereSql = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $primaryLocale = AppLocale::getPrimaryLocale();
        $locale = AppLocale::getLocale();
        $params = [
            ASSOC_TYPE_ARTICLE,
     ...
     * @return object DAOResultFactory
     */
    public function getEditorSubmissionsUnassigned($journalId, $sectionId, $editorId, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $result = $this->getUnfilteredEditorSubmissions(
     ...
     * @return object DAOResultFactory
     */
    public function getEditorSubmissionsInReview($journalId, $sectionId, $editorId, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $result = $this->getUnfilteredEditorSubmissions(
            $journalId, $sectionId, $editorId,
            $searchField, $searchMatch, $search,
            $dateField, $dateFrom, $dateTo,
     ...
     * @return object DAOResultFactory
     */
    public function getEditorSubmissionsInEditing($journalId, $sectionId, $editorId, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $result = $this->getUnfilteredEditorSubmissions(
            $journalId, $sectionId, $editorId,
            $searchField, $searchMatch, $search,
            $dateField, $dateFrom, $dateTo,
     ...
     * @return object DAOResultFactory
     */
    public function getEditorSubmissionsArchives($journalId, $sectionId, $editorId, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $result = $this->getUnfilteredEditorSubmissions(
            $journalId, $sectionId, $editorId,
            $searchField, $searchMatch, $search,
            $dateField, $dateFrom, $dateTo,
     ...
     * @return object DAOResultFactory
     */
    public function getEditorSubmissions($journalId, $sectionId, $editorId, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $result = $this->getUnfilteredEditorSubmissions(
            $journalId, $sectionId, $editorId,
            $searchField, $searchMatch, $search,
            $dateField, $dateFrom, $dateTo,
     ...
     * @return array
     */
    public function getEditorSubmissionsCount($journalId) {
        $submissionsCount = [];
        for($i = 0; $i < 3; $i++) {
    ...
    public function getEditorDecisions($articleId, $round = null) {
        ...
        while (!$result->EOF) {
            $decisions[] = ['editDecisionId' => $result->fields[0], 'editorId' => $result->fields[1], 'decision' => $result->fields[2], 'dateDecided' => $this->datetimeFromDB($result->fields[3])];
            $result->moveNext();
        }
        $result->Close();
        unset($result);
     ...
     * @param string|null $searchMatch
     * @param object|null $rangeInfo
     * @return object DAOResultFactory containing matching Users
     */
    public function getUsersNotAssignedToArticle($journalId, $articleId, $roleId, $searchType=null, $search=null, $searchMatch=null, $rangeInfo = null) {
        $paramArray = ['interest', (int) $articleId, (int) $journalId, (int) $roleId];
        $searchSql = '';
