...
class LanguageAction {
    ...
    public function LanguageAction() {
        if (Config::getVar('debug', 'deprecation_warnings')) {
            trigger_error('Class ' . get_class($this) . ' uses deprecated constructor parent::LanguageAction(). Please refactor to parent::__construct().', E_USER_DEPRECATED);
        }
        self::__construct();
    }
     ...
     * version.
     */
    public function getDownloadableLocales() {
     ...
     * @return boolean
     */
    public function downloadLocale($locale, &$errors) {
