...
import('core.Modules.notification.form.CoreNotificationSettingsForm');
...
class NotificationSettingsForm extends CoreNotificationSettingsForm {
     ...
     */
    public function NotificationSettingsForm() {
        if (Config::getVar('debug', 'deprecation_warnings')) {
            trigger_error('Class ' . get_class($this) . ' uses deprecated constructor parent::NotificationSettingsForm(). Please refactor to parent::__construct().', E_USER_DEPRECATED);
        }
        self::__construct();
    }
     ...
     * @return array
     */
    public function _getNotificationSettingsMap() {
        return array(
     ...
     * @return array
     */
    public function _getNotificationSettingCategories() {
        return array(
