...
/**
 * @file core.Modules.submission/copyeditor/CopyeditorSubmissionDAO.inc.php
 *
...
import('core.Modules.submission.copyeditor.CopyeditorSubmission');
...
class CopyeditorSubmissionDAO extends DAO {
     ...
     */
    public function CopyeditorSubmissionDAO() {
     ...
     * @param int $articleId
     * @return CopyeditorSubmission|null
     */
    public function getCopyeditorSubmission($articleId) {
        ...
        if ($result->RecordCount() != 0) {
            ...
            $returner = $this->_returnCopyeditorSubmissionFromRow($row);
        }
     ...
     */
    public function _returnCopyeditorSubmissionFromRow($row) {
        ...
        HookRegistry::dispatch('CopyeditorSubmissionDAO::_returnCopyeditorSubmissionFromRow', [&$copyeditorSubmission, &$row]);
     ...
     */
    public function getCopyeditorSubmissionsByCopyeditorId($copyeditorId, $journalId = null, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $active = true, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $locale = AppLocale::getLocale();
        $primaryLocale = AppLocale::getPrimaryLocale();
        $params = [
            'title', // Section title
    ...
    public function _generateUserNameSearchSQL($search, $searchMatch, $prefix, &$params) {
        ...
        // [WIZDAM] Explicit push for clarity
        $params[] = $search;
        $params[] = $search;
        $params[] = $search;
        $params[] = $search;
     ...
     * @return array
     */
    public function getSubmissionsCount($copyeditorId, $journalId) {
        $sectionEditorSubmissionDao = DAORegistry::getDAO('SectionEditorSubmissionDAO');
        $stats = $sectionEditorSubmissionDao->getCopyeditorStatistics($journalId, $copyeditorId);
        return [
            0 => $stats[$copyeditorId]['incomplete'] ?? 0,
            1 => $stats[$copyeditorId]['complete'] ?? 0
        ];
    }
