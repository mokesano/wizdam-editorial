...
import('core.Modules.submission.proofreader.ProofreaderSubmission');
...
class ProofreaderSubmissionDAO extends DAO {
     ...
     */
    public function ProofreaderSubmissionDAO() {
     ...
     * @return ProofreaderSubmission|null
     */
    ...
    public function _returnSubmissionFromRow(&$row) {
        ...
        HookRegistry::dispatch('ProofreaderSubmissionDAO::_returnProofreaderSubmissionFromRow', [&$submission, &$row]);
     ...
     */
    public function getSubmissions($proofreaderId, $journalId = null, $searchField = null, $searchMatch = null, $search = null, $dateField = null, $dateFrom = null, $dateTo = null, $active = true, $rangeInfo = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
        $primaryLocale = AppLocale::getPrimaryLocale();
        $locale = AppLocale::getLocale();
     ...
     * @return array
     */
    public function getSubmissionsCount($proofreaderId, $journalId) {
        $sectionEditorSubmissionDao = DAORegistry::getDAO('SectionEditorSubmissionDAO');
        $stats = $sectionEditorSubmissionDao->getProofreaderStatistics($journalId, $proofreaderId);
        return [
            0 => $stats[$proofreaderId]['incomplete'] ?? 0,
            1 => $stats[$proofreaderId]['complete'] ?? 0
        ];
    }
