...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1998/Math/MathML"
	xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" exclude-result-prefixes="m">
  ...
  <xsl:template match="/*[not(self::m:oMathPara)]">
    <math>
      <xsl:apply-templates select="*" />
    </math>
  </xsl:template>
