...
function chunker(selector) {
	var i = 0, l = selector.length, ch, quote = null, parenDepth = 0, bracketDepth = 0, esc = false;
	...
	for (; i < l; i++) {
		...
		if (ch === "," && parenDepth === 0 && bracketDepth === 0) {
			return [selector.slice(0, i), selector.slice(i, i + 1), selector.slice(i + 1)];
		}
	}
