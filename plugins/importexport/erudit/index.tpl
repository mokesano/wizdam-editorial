...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="10%">{translate key="submission.galley"}</td>
	</tr>
	<tr class="u-hide">
		<td colspan="4" class="headseparator">&nbsp;</td>
	</tr>
	...
	<tr valign="top">
		...
		<td align="center">
			...
			{foreach from=$publishedArticle->getGalleys() item=galley}
				...
				<a href="{plugin_url path="exportGalley"|to_array:$article->getId():$galley->getId()}" class="action">{$galley->getLabel()|escape}</a>
