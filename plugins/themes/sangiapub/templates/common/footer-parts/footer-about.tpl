{**
 * templates/common/footer-parts/footer-general.tpl
 *
 ...
 *}
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/chart.js@3.7.1" referrerpolicy="strict-origin-when-cross-origin"></script>
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/pako@2.0.4/dist/pako.min.js" referrerpolicy="strict-origin-when-cross-origin"></script>
    <script src="{$baseUrl}/assets/js/journal-stats.js" type="text/javascript"></script>
    <script src="{$baseUrl}/assets/js/sintaScore.js" type="text/javascript"></script>
