...
<a href="{url op="selectSubscriber" path="individual"}" class="link-button">{translate key="manager.subscriptions.create"}</a>
</div>
<div class="block">
...
<a href="{url op="selectSubscriber" path="institutional"}" class="link-button">{translate key="manager.subscriptions.create"}</a>
</div>
