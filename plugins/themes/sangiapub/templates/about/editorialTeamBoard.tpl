...
<div class="statement u-font-serif">All members of the Editorial Board have identified their affiliated institutions or organizations, along with the corresponding country or geographic region. {if $currentJournal->getSetting('publisherInstitution') == "Sangia Research Media and Publishing"}{$currentJournal->getSetting('publisherInstitution')|escape}{else}Production & hosted of Sangia Research Media & Publishing{/if} remains neutral with regard to any jurisdictional claims.
</div>
