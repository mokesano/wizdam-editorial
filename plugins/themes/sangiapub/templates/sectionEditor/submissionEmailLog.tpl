...
<div id="emailLogEntries">
    ...
    {if $isEditor}
    <a class="link-button" href="{url page="editor" op="clearSubmissionEmailLog" path=$submission->getId()}" onclick="return confirm('{translate|escape:"jsparam" key="submission.email.confirmClearLog"}')">{translate key="submission.history.clearLog"}</a>
    {/if}
</div>
