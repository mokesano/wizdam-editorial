...
class ObjectForReviewAssignmentDAO extends DAO {
    ...
    public function ObjectForReviewAssignmentDAO($parentPluginName) {
        trigger_error(
            "Class '" . get_class($this) . "' uses deprecated constructor parent::ObjectForReviewAssignmentDAO(). Please refactor to use parent::__construct().",
            E_USER_DEPRECATED
        );
    ...
    public function _fromRow($row) {
        ...
        HookRegistry::dispatch('ObjectForReviewAssignmentDAO::_fromRow', array(&$assignment, &$row));
    ...
    public function getInsertId($table = '', $id = '', $callHooks = true) {
        return parent::getInsertId('object_for_review_assignments', 'assignment_id', $callHooks);
    }
     ...
     */
    public function _getAllInternally($objectId = null, $userId = null, $submissionId = null) {
